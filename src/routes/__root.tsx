...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Açaí Do Lelei — Sabor que conquista" },
      { name: "description", content: "Açaí cremoso, ingredientes caprichados e combinações deliciosas. Conheça o Açaí Do Lelei." },
      { name: "author", content: "Açaí Do Lelei" },
      { property: "og:title", content: "Açaí Do Lelei — Sabor que conquista" },
      { property: "og:description", content: "Seu momento merece um açaí de verdade." },
